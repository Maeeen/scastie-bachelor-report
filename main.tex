...
To explain tihs problem more in detail, let's go with a quick overview of how Scastie works.
Scastie is a distributed system and has different components. Here is a quick visual representation of the architecture~:
